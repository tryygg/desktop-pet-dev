...
public class 动画界面控制器 : MonoBehaviour
{
    ...
    private float 过渡时长 = 0.25f;
    public float transitionDuration { get => 过渡时长; set => 过渡时长 = value; }

    [Header("三维软件式相机操作")]
    [Tooltip("Alt + 左键拖拽：绕目标旋转")]
    [SerializeField, FormerlySerializedAs("orbitSpeed"), InspectorName("环绕速度")]
    private float 环绕速度 = 180f;
    [Tooltip("中键拖拽：平移")]
    [SerializeField, FormerlySerializedAs("panSpeed"), InspectorName("平移速度")]
    private float 平移速度 = 0.0035f;
    [Tooltip("滚轮 / Alt + 右键拖拽：缩放")]
    [SerializeField, FormerlySerializedAs("zoomSpeed"), InspectorName("缩放速度")]
    private float 缩放速度 = 4f;
    [SerializeField, FormerlySerializedAs("minDistance"), InspectorName("最小距离")]
    private float 最小距离 = 0.25f;
    [SerializeField, FormerlySerializedAs("maxDistance"), InspectorName("最大距离")]
    private float 最大距离 = 20f;
    public float orbitSpeed { get => 环绕速度; set => 环绕速度 = value; }
    public float panSpeed { get => 平移速度; set => 平移速度 = value; }
    public float zoomSpeed { get => 缩放速度; set => 缩放速度 = value; }
    public float minDistance { get => 最小距离; set => 最小距离 = value; }
    public float maxDistance { get => 最大距离; set => 最大距离 = value; }

    [Header("UI 样式")]
    [SerializeField, FormerlySerializedAs("panelColor"), InspectorName("面板颜色")]
    private Color 面板颜色 = new Color(0.06f, 0.09f, 0.16f, 0.82f);
    [SerializeField, FormerlySerializedAs("buttonNormalColor"), InspectorName("按钮常态颜色")]
    private Color 按钮常态颜色 = new Color(0.15f, 0.22f, 0.36f, 0.92f);
    [SerializeField, FormerlySerializedAs("buttonHoverColor"), InspectorName("按钮悬停颜色")]
    private Color 按钮悬停颜色 = new Color(0.23f, 0.35f, 0.54f, 0.95f);
    [SerializeField, FormerlySerializedAs("buttonPressedColor"), InspectorName("按钮按下颜色")]
    private Color 按钮按下颜色 = new Color(0.11f, 0.17f, 0.28f, 1f);
    [SerializeField, FormerlySerializedAs("enablePreviewControls"), InspectorName("启用预览控制")]
    private bool 启用预览控制 = false;
    [SerializeField, FormerlySerializedAs("showControlUI"), InspectorName("显示控制UI")]
    private bool 显示控制界面 = false;
    public Color panelColor { get => 面板颜色; set => 面板颜色 = value; }
    public Color buttonNormalColor { get => 按钮常态颜色; set => 按钮常态颜色 = value; }
    public Color buttonHoverColor { get => 按钮悬停颜色; set => 按钮悬停颜色 = value; }
    public Color buttonPressedColor { get => 按钮按下颜色; set => 按钮按下颜色 = value; }
    public bool enablePreviewControls { get => 启用预览控制; set => 启用预览控制 = value; }
    public bool showControlUI { get => 显示控制界面; set => 显示控制界面 = value; }
...
{
    [SerializeField, FormerlySerializedAs("targetImage"), InspectorName("目标图片")]
    private Image 目标图片;
    [SerializeField, FormerlySerializedAs("targetText"), InspectorName("目标文本")]
    private Text 目标文本;

    [SerializeField, FormerlySerializedAs("normalColor"), InspectorName("常态颜色")]
    private Color 常态颜色 = new Color(0.15f, 0.22f, 0.36f, 0.92f);
    [SerializeField, FormerlySerializedAs("hoverColor"), InspectorName("悬停颜色")]
    private Color 悬停颜色 = new Color(0.23f, 0.35f, 0.54f, 0.95f);
    [SerializeField, FormerlySerializedAs("pressedColor"), InspectorName("按下颜色")]
    private Color 按下颜色 = new Color(0.11f, 0.17f, 0.28f, 1f);

    public Image targetImage { get => 目标图片; set => 目标图片 = value; }
    public Text targetText { get => 目标文本; set => 目标文本 = value; }
    public Color normalColor { get => 常态颜色; set => 常态颜色 = value; }
    public Color hoverColor { get => 悬停颜色; set => 悬停颜色 = value; }
    public Color pressedColor { get => 按下颜色; set => 按下颜色 = value; }
