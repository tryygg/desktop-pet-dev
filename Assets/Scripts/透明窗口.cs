...
public class 透明窗口 : MonoBehaviour
{
    public static 透明窗口 Instance { get; private set; }

    [Header("窗口")]
    [SerializeField, FormerlySerializedAs("initialWindowSize"), InspectorName("初始窗口大小")]
    private Vector2Int 初始窗口大小 = new Vector2Int(960, 960);
    [SerializeField, FormerlySerializedAs("forceWindowedModeOnStart"), InspectorName("启动强制窗口化")]
    private bool 启动强制窗口化 = true;
    [SerializeField, FormerlySerializedAs("keepTopMost"), InspectorName("始终置顶")]
    private bool 始终置顶 = true;
    [SerializeField, FormerlySerializedAs("hideFromAltTab"), InspectorName("从 Alt+Tab 隐藏")]
    private bool 从AltTab隐藏 = true;
    [SerializeField, FormerlySerializedAs("clickThroughOnEmptyArea"), InspectorName("空白区域穿透")]
    private bool 空白区域穿透 = true;
    [SerializeField, FormerlySerializedAs("useColorKeyTransparency"), InspectorName("使用色键透明")]
    private bool 使用色键透明 = true;
    [SerializeField, FormerlySerializedAs("useDwmAlphaTransparency"), InspectorName("使用 DWM 透明")]
    private bool 使用Dwm透明 = false;
    [SerializeField, FormerlySerializedAs("disablePostProcessingForTransparency"), InspectorName("透明时关闭后处理")]
    private bool 透明时关闭后处理 = true;
    [SerializeField, FormerlySerializedAs("transparentBackground"), InspectorName("透明背景色")]
    private Color 透明背景色 = new Color(1f, 0f, 1f, 1f);

    public Vector2Int initialWindowSize { get => 初始窗口大小; set => 初始窗口大小 = value; }
    public bool forceWindowedModeOnStart { get => 启动强制窗口化; set => 启动强制窗口化 = value; }
    public bool keepTopMost { get => 始终置顶; set => 始终置顶 = value; }
    public bool hideFromAltTab { get => 从AltTab隐藏; set => 从AltTab隐藏 = value; }
    public bool clickThroughOnEmptyArea { get => 空白区域穿透; set => 空白区域穿透 = value; }
    public bool useColorKeyTransparency { get => 使用色键透明; set => 使用色键透明 = value; }
    public bool useDwmAlphaTransparency { get => 使用Dwm透明; set => 使用Dwm透明 = value; }
    public bool disablePostProcessingForTransparency { get => 透明时关闭后处理; set => 透明时关闭后处理 = value; }
    public Color transparentBackground { get => 透明背景色; set => 透明背景色 = value; }
